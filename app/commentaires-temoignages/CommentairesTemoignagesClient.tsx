...
import { Quote, Star, PenLine, Heart, CheckCircle2 } from "lucide-react";

export default function CommentairesTemoignagesClient() {
  const avis = [
    {
      nom: "Marc-Antoine",
      date: "Mars 2026",
          ...
          <div className="bg-zinc-950/30 p-12 border border-zinc-900/50 space-y-10">
            ...
            <form className="grid gap-6">
              ...
              <div className="text-center pt-6">
                <button type="button" className="px-12 py-5 bg-white text-black uppercase tracking-[0.3em] text-[10px] font-bold hover:bg-amber-600 hover:text-white transition-all duration-500">
