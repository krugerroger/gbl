...
export default function PrivateDataReservationClient() {
              ...
              {reservations.map((res) => (
                <tr key={res.id} className="hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="px-6 py-6 text-right">
                    {res.ticketproof ? (
                      <a href={res.ticketproof} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-zinc-500 hover:text-white transition-colors text-[10px] uppercase tracking-widest font-sans underline decoration-amber-900 underline-offset-4">
          ...
          {reservations.map((res) => (
            <div key={res.id} className="bg-zinc-950 border border-zinc-900 p-6 space-y-6 relative overflow-hidden">
              ...
              <div className="flex justify-between items-center">
                ...
                {res.ticketproof && (
                  <a href={res.ticketproof} target="_blank" rel="noopener noreferrer" className="text-amber-800 text-[10px] uppercase font-bold tracking-widest flex items-center gap-2">
